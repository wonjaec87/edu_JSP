...
<body>
	...
	<h1>${sessionScope.username}님! 정보</h1>
	<form action="/Membership/update.jsp" method="post" name="myform">
		<ul>
			<li>Name : ${member.getUsername()}</li>
			<li>ID : <input type="text" name="userid" value="${sessionScope.userid}" readonly></li>
			...
			<li>Address : <input type="text" name="address1" readonly="readonly" size="50" value="${member.getAddress1()}"></li>
